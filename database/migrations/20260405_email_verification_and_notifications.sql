...
VALUES (
  'fadhlurrohmanluthfi@gmail.com',
  '$2y$12$4.8bTUnKgsWR/Js3cW.04uaQc9aerTIew7nPSpCf7V7aB2I3KQ8S2',
  'Admin Ujiin',
  'admin',
  NOW()
);
...
VALUES (
  ...
  JSON_OBJECT('email', 'fadhlurrohmanluthfi@gmail.com', 'completed_at', NOW())
)
